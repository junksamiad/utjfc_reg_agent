...
async def send_payment_sms(billing_request_id: str, parent_phone: str, child_name: str, registration_id: str = None) -> dict:
    """
    ...
    Args:
        ...
        registration_id: Optional registration ID for database logging
...
def send_payment_sms_sync(billing_request_id: str, parent_phone: str, child_name: str, registration_id: str = None) -> dict:
    """
    ...
    return asyncio.run(send_payment_sms(billing_request_id, parent_phone, child_name, registration_id))


# For AI agent tool calling
async def ai_send_sms_payment_link(billing_request_id: str, parent_phone: str, child_name: str, registration_id: str = None) -> str:
    """
    ...
    Args:
        ...
        registration_id: Registration ID from database write (optional)
    ...
    try:
        result = await send_payment_sms(billing_request_id, parent_phone, child_name, registration_id)
