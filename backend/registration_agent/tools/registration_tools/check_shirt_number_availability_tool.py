...
def check_shirt_number_availability(**kwargs) -> Dict[str, Any]:
    ...
    Args:
        ...
        requested_shirt_number (int): Shirt number to check (1-20)
    ...
    try:
        ...
        if not isinstance(requested_shirt_number, int) or not (1 <= requested_shirt_number <= 20):
            return {
                "success": False,
                "message": "Requested shirt number must be an integer between 1 and 20"
            }
...
def generate_shirt_number_check_schema():
    ...
    return {
        ...
        3. What alternative numbers are available (1-20 range)
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "requested_shirt_number": {
                    ...
                    "minimum": 1,
                    "maximum": 20,
                    "description": "The shirt number the player wants (1-20)"
                }
            },
