...
class KitDetailsData(BaseModel):
    ...
    shirt_number: int = Field(
        ...
        ge=1,
        le=49,
        description="Shirt number chosen by player (1-49) - should be extracted from conversation history where they chose their shirt number"
    )
...
def generate_update_kit_details_schema():
    ...
    return {
        ...
        - If shirt_number is any other number (2-11, 13-49), set kit_type_required to 'Outfield'
        """,
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "kit_type_required": {
                    ...
                    "description": "Type of kit required. Set to 'Goalkeeper' if shirt_number is 1 or 12, otherwise set to 'Outfield' for all other shirt numbers (2-11, 13-49)"
                },
                "kit_size": {
                    "type": "string",
                ...
                "shirt_number": {
                    ...
                    "minimum": 1,
                    "maximum": 49,
                    "description": "Shirt number chosen by player (1-49) - extract from conversation history where they chose their shirt number and it was confirmed as available"
                },
                "record_id": {
                    "type": "string",
